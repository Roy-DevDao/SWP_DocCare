...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-3MI8E3L;Initial Catalog=DocCare;Integrated Security=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3214EC077D3BAC9F");
        ...
        {
            entity.HasKey(e => e.ContactId).HasName("PK__Contact__5C66259B482F6457");
        ...
        {
            entity.HasKey(e => e.DetailId).HasName("PK__DetailDo__135C316D5FF9CCAF");
        ...
        {
            entity.HasKey(e => e.DetailId).HasName("PK__DetailSp__135C316D95D62DEB");
        ...
        {
            entity.HasKey(e => e.Did).HasName("PK__Doctor__C0365650838D11EF");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__6A4BEDD62450A190");
        ...
        {
            entity.HasKey(e => e.RecordId).HasName("PK__HealthRe__FBDF78E9A0370D73");
        ...
        {
            entity.HasKey(e => e.OptionId).HasName("PK__Option__92C7A1FFD6D63F34");
        ...
        {
            entity.HasKey(e => e.Oid).HasName("PK__Order__CB394B192234538C");
        ...
        {
            entity.HasKey(e => e.Pid).HasName("PK__Patient__C5775540015D2C38");
        ...
        {
            entity.HasKey(e => e.PayId).HasName("PK__Payment__EE8FCECFD899E1AF");
        ...
        {
            entity.HasKey(e => e.SpecialtyId).HasName("PK__Specialt__D768F6A817923BBB");
