...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3214EC07DDC9AFB1");
        ...
        {
            entity.HasKey(e => e.ContactId).HasName("PK__Contact__5C66259B33FA2A63");
        ...
        {
            entity.HasKey(e => e.DetailId).HasName("PK__DetailDo__135C316D4A54ED5F");
        ...
        {
            entity.HasKey(e => e.DetailId).HasName("PK__DetailSp__135C316D3D285EC9");
        ...
        {
            entity.HasKey(e => e.Did).HasName("PK__Doctor__C036565063969F93");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__6A4BEDD602E1CFE4");
        ...
        {
            entity.HasKey(e => e.RecordId).HasName("PK__HealthRe__FBDF78E97783275E");
        ...
        {
            entity.HasKey(e => e.OptionId).HasName("PK__Option__92C7A1FF18AC28DE");
        ...
        {
            entity.HasKey(e => e.Oid).HasName("PK__Order__CB394B194D2603D5");
        ...
        {
            entity.HasKey(e => e.Pid).HasName("PK__Patient__C5775540D708992F");
        ...
        {
            entity.HasKey(e => e.PayId).HasName("PK__Payment__EE8FCECFE25D9909");
        ...
        {
            entity.HasKey(e => e.SpecialtyId).HasName("PK__Specialt__D768F6A8530DAE31");
