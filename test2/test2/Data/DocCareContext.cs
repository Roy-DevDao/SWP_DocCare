...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3214EC0746CC7D20");
        ...
        {
            entity.HasKey(e => e.ContactId).HasName("PK__Contact__5C66259BFFE02FC5");
        ...
        {
            entity.HasKey(e => e.DetailId).HasName("PK__DetailDo__135C316D232B4FF1");
        ...
        {
            entity.HasKey(e => e.DetailId).HasName("PK__DetailSp__135C316D116016A5");
        ...
        {
            entity.HasKey(e => e.Did).HasName("PK__Doctor__C03656506CA9D24A");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__6A4BEDD62230281A");
        ...
        {
            entity.HasKey(e => e.RecordId).HasName("PK__HealthRe__FBDF78E908E8E41C");
        ...
        {
            entity.HasKey(e => e.OptionId).HasName("PK__Option__92C7A1FF6B1483EC");
        ...
        {
            entity.HasKey(e => e.Oid).HasName("PK__Order__CB394B19A8D60165");
        ...
        {
            entity.HasKey(e => e.Pid).HasName("PK__Patient__C57755407062E909");
        ...
        {
            entity.HasKey(e => e.PayId).HasName("PK__Payment__EE8FCECFFFB8055E");
        ...
        {
            entity.HasKey(e => e.SpecialtyId).HasName("PK__Specialt__D768F6A82B7D9445");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__Staff__96D4AB1781A06D6C");
