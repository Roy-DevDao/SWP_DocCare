...
namespace test2.Controllers
{
    ...
    public class DoctorController : Controller
    {
        ...
        public DoctorController(ILogger<DoctorController> logger, AppointmentDAO appointmentDAO, PatientDao patientDao, FeedbackDAO feedbackDao, DocCareContext ct, UserDAO _userDAO, CloudinaryService cloudinaryService, DoctorDAO doctorDAO)
        {
            _logger = logger;
