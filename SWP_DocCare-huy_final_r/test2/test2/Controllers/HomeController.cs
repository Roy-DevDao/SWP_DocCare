...
namespace test2.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Login(string email, string password)
        {
            ...
            {
                return Json(new { status = false, mess = "Yêu cầu nhập cả Tài khoản và Mật Khẩu" });
            }
                ...
                var claims = new List<Claim>
        {
            ...
            new Claim(ClaimTypes.Role, user.Role.ToString())
                ...
                {
                    return Json(new { status = false, mess = "Không có quyền truy cập" });
                }
            }

            // Trả về thông báo nếu email hoặc mật khẩu không hợp lệ
            return Json(new { status = false, mess = "Email hoặc Mật Khẩu không hợp lệ!" });
        }
            ...
            var addClaim = new List<Claim>()
    {
        ...
        public IActionResult SignUp1(RegisterViewModel model)
        {
            ...
            try
            {
                ...
                var newPatient = new Patient
                {
                    Pid = newAccount.Id,
                    Name = model.FullName,
                    PatientImg = "https://static.vecteezy.com/system/resources/previews/009/292/244/non_2x/default-avatar-icon-of-social-media-user-vector.jpg",
                    Phone = model.Phone,
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            ...
            if (!ModelState.IsValid)
            {
                model.Message = "Hãy nhập mọi thông tin yêu cầu!";
            ...
            if (account == null)
            {
                ...
                ModelState.AddModelError(string.Empty, "Email không khớp!");
            ...
            var body = $"Nhập vào liên kết để khôi phục mật khẩu của bạn: <a href='{resetLink}'>Đổi Mật Khẩu</a>. Liên kết này chỉ tồn tại trong 15 phút.";
            ...
            model.Message = "Liên kết đã được gửi về email của bạn.";
        ...
        public IActionResult ResetPassword(string token)
        {
            ...
            ViewBag.Message = "Kí tự không hợp lệ hoặc đã hết hạn! Quay về trang nhập Email lại!";
            return View("Error");
        }
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            TempData["SuccessMessage"] = "Mật khẩu của bạn được đổi thành công";
            return RedirectToAction("Login");
        }
        //--------------------------------------------------------------------------------------------
        ...
        public IActionResult Contact(ContactModel model)
        {
			...
			int buff = random.Next(10, 99);
			if (ModelState.IsValid)
            {
                var contact = new Contact
                {
                    ContactId = "Contact-"+buff,
                    Name = model.Name,
                    Email = model.Email,
                    Title = model.Title,
